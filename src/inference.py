...
@torch.no_grad()
def _inference(args: argparse.Namespace, config: AttrDict, device: str, mel_spectrograms: list[torch.Tensor],
               filenames: list[str], stft: TorchSTFT):
...
@torch.no_grad()
def _onnx_inference(args: argparse.Namespace, config: AttrDict, device: str, mel_spectrograms: list[torch.Tensor],
                    filenames: list[str], stft: TorchSTFT):
    specs, phases = [], []
